...
#define AGINGSCHED 	1		/* aging scheduler 		*/ 
#define LINUXSCHED 	2		/* linux like scheduler		*/
#define DEFAULT		0		/* default xinu scxheduler	*/
...
extern	int		scheduleclass; //  SCHEDULE CLASS VARIABLE
extern	int 	nepoch;		//NEW EPOCH OR NOT
extern	int 	threshold;	// THRESHOLF FOR ROLL OVER
